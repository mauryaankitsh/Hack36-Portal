...
<head>
    <title>Hack36-Coordinator Login</title>
    <!-- Meta tag Keywords -->
                ...
                <form action="login1.php" method="post">
                   ...
                   <input type="submit" id="submit" name="submit" value="Submit" class="btn btn-success btn-block">
                    <div class="row sub-w3l mt-3 mb-5">
                        ...
                        <input type="submit" id="forget_pass_submit" name="forget_pass_submit" value="Forgot Password?">
  ...
  // require('inc/config.php');
   if(isset($_POST['submit'])){
    ...
    $year=mysqli_escape_string($db,$_POST['year']);
     $query = "SELECT * FROM coordinates WHERE cemail = '$email_address' AND password= '$password' and status=1 and year='$year'";
