...
<html>
<head>
    <title>New Mentor Details</title>
...
<body style="background-color:#CCD1D1 ;">
	...
	<div class="row">
        ...
        <form action='mentor.php' method="post" class="form-container">
        <h1>Mentor Details</h1>
        <div class="form-group">
            <label for="exampleInputEmail1">Mentor Name</label>
            <input type="text" class="form-control" id="name" name="name" placeholder="Mentor Name" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" id="email" name="email" placeholder="mentor@mail.com" required>
        </div>
        <div class="form-group">
    ...
    $query = "INSERT INTO mentor(name,contact,email,year) VALUES ('$name','$contact','$email','$year')";
