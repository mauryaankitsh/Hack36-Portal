...
$sql = 'SELECT * FROM coordinates where status=0';
...
<html>
<head>
    <title>Pending Coordinator Requests</title>
...
<body>
	...
	<table class="data-table">
		<h3><caption class="title" style="margin-top:50px">Pending Coordinator Requests</caption></h3>
		<thead>
			<tr>
				<th>ID</th>
				<th>NAME</th>
		...
		<tfoot>
			<tr>
				<th colspan="5">TOTAL PENDING REQUESTS</th>
