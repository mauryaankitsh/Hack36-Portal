...
<html>
<head>
    <title>New Sponsor Details</title>
...
<body style="background-color:#CCD1D1 ;">
	...
	<div class="row">
        ...
        <form action='sponsors.php' method="post" class="form-container">
        <h1>Sponsor Details</h1>
        <div class="form-group">
            <label for="exampleInputEmail1">Sponsor Name</label>
            <input type="text" class="form-control" id="name" name="name" placeholder="Sponsor Name" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="email" name="email" placeholder="sponsor@web" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="exampleInputAmount">Amount Received</label>
    ...
    $sname = mysqli_escape_string($db,$_POST['name']) ;
    ...
    $query = "INSERT INTO `sponsors`(`sname`, `amount`, `contact`, `email`, `year`) VALUES ('$sname','$amount','$contact','$email','$year')";
