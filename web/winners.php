...
<html>
<head>
    <title>New Winner Details</title>
...
<body style="background-color:#CCD1D1 ;">
	...
	<div class="row">
        ...
        <form action='winners.php' method="post" class="form-container">
        ...
        <div class="form-group">
            <label for="exampleInputName">Postion</label>
        ...
        <div class="form-group">
            <label for="exampleInputAmount">Winning Amount</label>
    ...
    $tname = mysqli_escape_string($db,$_POST['name']) ;
    $tposition = mysqli_escape_string($db,$_POST['position']);
    $year = mysqli_escape_string($db,$_POST['year']);
    $amount = mysqli_escape_string($db,$_POST['amount']);
    
    $query = "INSERT INTO winners (tname ,tposition ,amount ,year ) VALUES ('$tname','$tposition','$amount','$year')";
